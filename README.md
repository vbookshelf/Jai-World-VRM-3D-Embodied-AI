...
Interact with your AI agent in a virtual world. Build 3D Embodied AI with VRM Avatars. A desktop folder-based Flask app that supports both Ollama and OpenRouter.
