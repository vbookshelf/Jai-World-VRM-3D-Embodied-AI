...
This project explores personalized 3D world generation, embodied AI, AI spatial navigation, and virtual character interaction. It establishes a basic architecture that can be tuned and expanded.
