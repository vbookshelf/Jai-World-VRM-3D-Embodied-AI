...
Interact with your VRM Embodied agent in a 3D virtual world. A local Flask app that supports both Ollama and OpenRouter. This is basic starter code. You can use vibe coding to expand and experiment.<br>
