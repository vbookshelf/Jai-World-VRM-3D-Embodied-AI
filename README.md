...
This project explores personalized 3D world generation, embodied AI, AI spatial navigation, and virtual character interaction. This code is a starting point that can be tuned and expanded.
