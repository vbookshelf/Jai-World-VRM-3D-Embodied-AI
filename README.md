...
Interact with your AI agent in a 3D virtual world. Build 3D Embodied AI with VRM Avatars. A desktop folder-based Flask app that supports both Ollama and OpenRouter.
...
The dance feature in this app is a pre-made mixamo animation.
